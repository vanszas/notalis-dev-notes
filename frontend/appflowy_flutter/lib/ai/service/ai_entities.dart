...
class AiPrompt extends Equatable {
  ...
  String localizedName(bool isId) => isId && nameId.isNotEmpty ? nameId : name;
  String localizedContent(bool isId) => isId && contentId.isNotEmpty ? contentId : content;
  String localizedExample(bool isId) => isId && exampleId.isNotEmpty ? exampleId : example;
