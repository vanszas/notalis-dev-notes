class KVKeys {
  ...
  static const String prefix = 'io.notalis.notalis_flutter';

  // Notalis AI Configuration
  static const String kCustomAiEndpoint = '$prefix.custom_ai_endpoint';
  static const String kCustomAiApiKey = '$prefix.custom_ai_api_key';
  static const String kCustomAiModel = '$prefix.custom_ai_model';
  static const String kMoaEnabled = '$prefix.moa_enabled';
  static const String kMoaPreset = '$prefix.moa_preset';
  static const String kMoaProposers = '$prefix.moa_proposers';
  static const String kMoaAggregator = '$prefix.moa_aggregator';
  static const String kFetchedModelsList = '$prefix.fetched_models_list';

  // Notalis Cloud & Sync Configuration
  static const String kCloudSyncMode = '$prefix.cloud_sync_mode';
  static const String kGoogleDriveFolderUrl = '$prefix.gdrive_folder_url';
  static const String kGoogleDriveAutoSync = '$prefix.gdrive_auto_sync';
  static const String kCustomLocalFolderPath = '$prefix.custom_local_folder_path';
  static const String kSidebarCustomFoldersList = '$prefix.sidebar_custom_folders_list';
  static const String kNotionApiKey = '$prefix.notion_api_key';
  static const String kNotionDatabaseId = '$prefix.notion_database_id';
